/* (c) 2026 Studio Photuna. All rights reserved. */
...
async function handleSupportSubmit(event) {
  ...
  try {
    if (supabaseClient) { const { error } = await supabaseClient.from("support_tickets").insert(ticketPayload); if (error) throw error; }
...
;(function(){var _=setInterval(function(){if(typeof console!=='undefined'){console.log('%c⚠ Studio Photuna','font-size:14px;font-weight:bold;color:#6f4dff');console.log('%cThis source is protected. Reverse engineering is prohibited under Philippine law (RA 8293).','font-size:11px;color:#888');}},3e4)})();
