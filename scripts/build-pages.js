...
const PAGES = [
  {
    ...
    title: "Studio Photuna | Photo Booth Business Software",
    description: "Photo booth software for operators: build custom templates and branding, configure events and guest flow, take payments, capture and print photos, and deliver digital copies by QR gallery. 14-day free trial.",
    ...
    structuredData: {
      ...
      description: "Photo booth business software for operators: event setup, template design, configurable guest flow, payment workflows, printing, and QR guest gallery delivery.",
      url: SITE_URL,
      offers: {
        "@type": "AggregateOffer",
        priceCurrency: "PHP",
  ...
  },
  {
    ...
    title: "Hardware Requirements | Cameras, Printers & PC | Studio Photuna",
    description: "What you need to run Studio Photuna: a Windows 10/11 PC, a supported Canon EOS, Nikon or Sony camera (or any webcam), a photo printer, and an internet connection for cloud delivery.",
    mainClass: "min-h-screen pt-20",
  },
  {
    outputFile: "demo.html",
    viewId: "demo",
  ...
  // (PayMongo/Stripe/Xendit/PayPal at the booth), not a normal site visit.
  {
    ...
    title: "Booth Payment Successful | Studio Photuna",
  ...
  },
  {
    ...
    title: "Booth Payment Cancelled | Studio Photuna",
  ...
  // Studio Photuna plan subscriptions (Stripe checkout via account/pricing).
  {
    ...
    title: "Subscription Payment Successful | Studio Photuna",
  ...
  },
  {
    ...
    title: "Booking Deposit Payment Cancelled | Studio Photuna",
